...
var $input = document.querySelector('.parse-english-editor__input');
var $output = document.querySelector('.parse-english-output__tree');
...
function onuserinput() {
    ...
    highlightedSourceCode = highlightJSON(
        parseEnglish.tokenizeRoot($input.value)
    );
...
}, {"parse-latin":3,"nlcst-to-string":4}],
...
}, {"./parser":6,"./expressions":7,"./plugin":8,"./modifier":9,"./plugin/merge-initial-word-symbol":10,"./plugin/merge-final-word-symbol":11,"./plugin/merge-inner-word-symbol":12,"./plugin/merge-initialisms":13,"./plugin/merge-non-word-sentences":14,"./plugin/merge-affix-symbol":15,"./plugin/merge-initial-lower-case-letter-sentences":16,"./plugin/merge-prefix-exceptions":17,"./plugin/merge-affix-exceptions":18,"./plugin/merge-remaining-full-stops":19,"./plugin/make-initial-white-space-siblings":20,"./plugin/make-final-white-space-siblings":21,"./plugin/break-implicit-sentences":22,"./plugin/remove-empty-nodes":23}],
...
}, {"nlcst-to-string":4,"../modifier":9,"../expressions":7}],
...
}, {"nlcst-to-string":4,"../plugin":8,"../expressions":7}],
