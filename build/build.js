...
require.register("wooorm~parse-english@0.3.0-rc.1", function (exports, module) {
'use strict';
...
Parser = require('wooorm~parse-latin@0.3.0-rc.1');
nlcstToString = require('wooorm~nlcst-to-string@0.1.1');
...
var ParseEnglish = require('wooorm~parse-english@0.3.0-rc.1');
