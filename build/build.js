...
require.register("wooorm~parse-latin@0.4.0", function (exports, module) {
'use strict';

module.exports = require('wooorm~parse-latin@0.4.0/lib/parse-latin.js');

});

require.register("wooorm~parse-latin@0.4.0/lib/expressions.js", function (exports, module) {
module.exports = {
    'affixSymbol': /^([\)\]\}\u0F3B\u0F3D\u169C\u2046\u207E\u208E\u2309\u230B\u232A\u2769\u276B\u276D\u276F\u2771\u2773\u2775\u27C6\u27E7\u27E9\u27EB\u27ED\u27EF\u2984\u2986\u2988\u298A\u298C\u298E\u2990\u2992\u2994\u2996\u2998\u29D9\u29DB\u29FD\u2E23\u2E25\u2E27\u2E29\u3009\u300B\u300D\u300F\u3011\u3015\u3017\u3019\u301B\u301E\u301F\uFD3E\uFE18\uFE36\uFE38\uFE3A\uFE3C\uFE3E\uFE40\uFE42\uFE44\uFE48\uFE5A\uFE5C\uFE5E\uFF09\uFF3D\uFF5D\uFF60\uFF63]|["'\xBB\u2019\u201D\u203A\u2E03\u2E05\u2E0A\u2E0D\u2E1D\u2E21]|[!\.\?\u2026\u203D])\1*$/,
    'newLine': /^(\r?\n|\r)+$/,
    'newLineMulti': /^(\r?\n|\r){2,}$/,
...
require.register("wooorm~parse-latin@0.4.0/lib/modifier.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/parse-latin.js", function (exports, module) {
/**!
 * parse-latin
 *
 * Licensed under MIT.
...
parser = require('wooorm~parse-latin@0.4.0/lib/parser.js');
expressions = require('wooorm~parse-latin@0.4.0/lib/expressions.js');
pluginFactory = require('wooorm~parse-latin@0.4.0/lib/plugin.js');
modifierFactory = require('wooorm~parse-latin@0.4.0/lib/modifier.js');
...
parseLatinPrototype.use('tokenizeSentence', [
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-initial-word-symbol.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-final-word-symbol.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-inner-word-symbol.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-initialisms.js')
]);

parseLatinPrototype.use('tokenizeParagraph', [
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-non-word-sentences.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-affix-symbol.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-initial-lower-case-letter-sentences.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-prefix-exceptions.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-affix-exceptions.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/merge-remaining-full-stops.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/make-initial-white-space-siblings.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/make-final-white-space-siblings.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/break-implicit-sentences.js'),
    require('wooorm~parse-latin@0.4.0/lib/plugin/remove-empty-nodes.js')
]);
...
require.register("wooorm~parse-latin@0.4.0/lib/parser.js", function (exports, module) {
'use strict';

var tokenizer;

tokenizer = require('wooorm~parse-latin@0.4.0/lib/tokenizer.js');
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/break-implicit-sentences.js", function (exports, module) {
'use strict';
...
plugin = require('wooorm~parse-latin@0.4.0/lib/plugin.js');
expressions = require('wooorm~parse-latin@0.4.0/lib/expressions.js');
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/make-final-white-space-siblings.js", function (exports, module) {
'use strict';
...
modifier = require('wooorm~parse-latin@0.4.0/lib/modifier.js');
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/make-initial-white-space-siblings.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-affix-exceptions.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-affix-symbol.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-final-word-symbol.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-initial-lower-case-letter-sentences.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-initial-word-symbol.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-initialisms.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-inner-word-symbol.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-non-word-sentences.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-prefix-exceptions.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/merge-remaining-full-stops.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/plugin/remove-empty-nodes.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-latin@0.4.0/lib/tokenizer.js", function (exports, module) {
'use strict';
...
require.register("wooorm~parse-english@0.4.0", function (exports, module) {
'use strict';
...
Parser = require('wooorm~parse-latin@0.4.0');
nlcstToString = require('wooorm~nlcst-to-string@0.1.2');
